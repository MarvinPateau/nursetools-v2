      ...
      <div className="mx-auto w-full max-w-3xl px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label="Toggle Sprout"
            className="p-1 rounded-full hover:bg-surface focus:outline-none focus:ring-2 focus:ring-ring"
            aria-pressed={sprout}
          >
            <Sprout className={sprout ? 'text-primary' : 'text-muted'} />
          </button>
        </div>
      </div>
    </header>
